...
import { Gift, User, Mail, ArrowRight, Sparkles } from 'lucide-react'
        ...
        <div className="min-h-screen grid grid-cols-1 lg:grid-cols-2">
            ...
            <div className="hidden lg:flex flex-col justify-center items-center bg-gradient-to-br from-[#0f172a] via-[#1e293b] to-black relative overflow-hidden p-12 text-center text-white">
                ...
                <div className="relative z-10 max-w-lg">
                    ...
                    <h1 className="text-4xl font-bold mb-6 leading-tight">Join the Magic of Giving</h1>
                    <p className="text-lg text-slate-300">Create unforgettable holiday memories. Organize Secret Santas effortlessly.</p>
                </div>
            </div>
            ...
            <div className="flex items-center justify-center p-8 bg-slate-950 text-white relative">
                <div className="w-full max-w-md space-y-8">
                    <div className="text-center">
                        ...
                        <p className="text-slate-400 mt-2">Sign up to start your exchange</p>
                    </div>

                    <div className="glass-card p-8 border border-white/5 shadow-2xl shadow-primary/5">
                        {message && (
                            <div className={`p-3 rounded-lg text-sm mb-4 ${message.includes("Success") || message.includes("created") ? "bg-green-500/20 text-green-400" : "bg-red-500/20 text-red-400"}`}>
                                {message}
                            </div>
                        )}
